...
const Page = () => {
  ...
  >
          <ImageBackground
        source={{
          uri: "https://r1.ilikewallpaper.net/iphone-14-wallpapers/download-25189/Nature-Mist-Mountain-Wood-Forest-River-Landscape.jpg", // Thay bằng URL hình nền của bạn
        }}
