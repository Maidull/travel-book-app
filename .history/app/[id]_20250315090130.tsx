  ...
  return (
    <>
      <Stack.Screen
        options={{
          headerTitle: "",
          headerTransparent: false, // Bỏ transparent để tránh bị che mất
          headerStyle: {
            backgroundColor: "white", // Chỉnh màu để dễ thấy
          },
          headerLeft: () => (
            <TouchableOpacity
              onPress={() => router.push("/")}
              style={{
                marginLeft: 10,
                padding: 10,
                backgroundColor: "rgba(0,0,0,0.1)", // Tạo nền mờ để dễ thấy
                borderRadius: 10,
              }}
            >
